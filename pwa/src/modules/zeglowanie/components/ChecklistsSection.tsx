...
import { checklistStorageKey, isValidChecklistType, STORAGE_KEYS, crewLabel } from '../storage-keys';
...
const checklistOptions = [
  { value: 'morning' as ChecklistType, emoji: '🌅', label: 'Codziennie rano', sublabel: 'Poranne czynności' },
  { value: 'departure' as ChecklistType, emoji: '⚓', label: 'Wyjście z portu', sublabel: 'Przed wypłynięciem' },
  { value: 'mooring' as ChecklistType, emoji: '🛟', label: 'Cumowanie', sublabel: 'Wejście do portu' },
  { value: 'grabbag' as ChecklistType, emoji: '🎒', label: 'Grab bag', sublabel: 'Torba ratunkowa' },
];

export function ChecklistsSection() {
  const [checklistType, setChecklistType] = useLocalStorage<ChecklistType>(
    STORAGE_KEYS.CHECKLIST_TYPE, 'morning', isValidChecklistType
  );
  ...
  return (
    <>
      <TypeSelector options={checklistOptions} current={checklistType} onChange={setChecklistType} />
