      ...
      <div className="relative z-10 max-w-lg md:max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-white/40">
            Baza pytań egzaminacyjnych &middot; {totalQ} pytań
          </p>
        </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2">
                    <span
                      style={{ width: 8, height: 8, borderRadius: '50%', background: colors.dot }}
                    ></span>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <div className="text-xs text-blue-400/60 mt-0.5">
              Powtórki rozłożone w czasie &middot; {dueCount} do powtórki &middot; {masteredCount}{' '}
              opanowanych
            </div>
          </button>
