      ...
      <div className="relative z-10 max-w-lg md:max-w-2xl mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-white/50 leading-relaxed max-w-sm mx-auto">
            Aby korzystać z modułu egzaminacyjnego, zaimportuj plik PDF z bazą pytań
            egzaminacyjnych.
          </p>
        </div>
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-white/60 leading-relaxed">
                  Suma kontrolna SHA-256 tego pliku nie odpowiada oczekiwanej wartosci. Plik moze
                  byc niekompatybilny z ta wersja aplikacji.
                </p>
              </div>
            </div>
