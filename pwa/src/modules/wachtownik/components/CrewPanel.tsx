...
export function CrewPanel({
  isNightMode, userLocale, crew, newCrewName, setNewCrewName,
  newCrewRole, setNewCrewRole, captainParticipates, setCaptainParticipates,
  recommendations, addCrew, removeCrew,
  startDate, setStartDate, days, setDays,
}: CrewPanelProps) {
  return (
