...
fun AnchorSession.toEntity(): AnchorSessionEntity {
    ...
    when (zone) {
        ...
        is AnchorZone.SectorWithCircle -> {
            zoneTypeStr = "SECTOR"
            sectorRadius = (zone as AnchorZone.SectorWithCircle).sectorRadiusMeters
            sectorAngle = (zone as AnchorZone.SectorWithCircle).sectorHalfAngleDeg
            sectorBearing = (zone as AnchorZone.SectorWithCircle).sectorBearingDeg
        }
    }
